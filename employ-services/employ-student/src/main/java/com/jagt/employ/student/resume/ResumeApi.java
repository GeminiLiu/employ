...
import com.jagt.employ.student.resume.dto.ResumeCreateDto;
...
public class ResumeApi {
    ...
    public String modifyResumeBaseInfo(@ApiParam(name="id",value = "简历ID",required=true) Long id, @ModelAttribute ResumeCreateDto resumeCreate){
        return "10086010086";
    }
    ...
    public String createResumeBaseInfo(@ModelAttribute ResumeCreateDto resumeCreate){
        return "10086010086";
    }
    ...
    public String createResumeWorkInfo(@ModelAttribute ResumeCreateDto resumeCreate){
        return "10086010086";
    }
    ...
    public String createResumeTargetInfo(@ModelAttribute ResumeCreateDto resumeCreate){
        return "10086010086";
    }
